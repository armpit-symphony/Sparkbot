...
The current hands-free browser voice release is `v1.6.41`.
...
bash scripts/package-public-download.sh \
  --ref desktop-v1.6.41 \
  --artifact-prefix sparkbot-1.6.41 \
  --output-dir dist/public-download/1.6.41
```
...
```bash
bash scripts/package-public-download.sh \
  --notes-file docs/release-notes/v1.6.41.txt
```
